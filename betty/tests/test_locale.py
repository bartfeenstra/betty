...
class DateTest(TestCase):
    ...
    @parameterized.expand([
        ...
        (False, Date(1970, 1, 1)),
        (False, Date(1969, 1, 1)),
        (False, Date(1969, 12, 31)),
        (True, Period(Date(1970, 1, 2))),
        (True, Period(Date(1970, 2, 1))),
        (True, Period(Date(1971, 1, 1))),
        (False, Period(Date(1970, 1, 1))),
        (False, Period(Date(1969, 1, 1))),
        (False, Period(Date(1969, 12, 31))),
        (True, Period(None, Date(1970, 1, 2))),
        (True, Period(None, Date(1970, 2, 1))),
        (True, Period(None, Date(1971, 1, 1))),
        (False, Period(None, Date(1970, 1, 1))),
        (False, Period(None, Date(1969, 1, 1))),
        (False, Period(None, Date(1969, 12, 31))),
    ])
    ...
    def test_lt_should_raise_typeerror_for_missing_parts(self, other):
    ...
    @parameterized.expand([
        ...
        (False, Date(1970, 1, 1)),
        (True, Date(1969, 1, 1)),
        (True, Date(1969, 12, 31)),
        (False, Period(None, Date(1970, 1, 2))),
        (False, Period(None, Date(1970, 2, 1))),
        (False, Period(None, Date(1971, 1, 1))),
        (False, Period(None, Date(1970, 1, 1))),
        (True, Period(None, Date(1969, 1, 1))),
        (True, Period(None, Date(1969, 12, 31))),
        (False, Period(Date(1970, 1, 2))),
        (False, Period(Date(1970, 2, 1))),
        (False, Period(Date(1971, 1, 1))),
        (False, Period(Date(1970, 1, 1))),
        (True, Period(Date(1969, 1, 1))),
        (True, Period(Date(1969, 12, 31))),
    ])
    ...
    def test_gt_should_raise_typeerror_for_missing_parts(self, other):
        with self.assertRaises(TypeError):
            Date(1970, 1, 1) > other
