...
class TestTemplate(TemplateTestCase):
    ...
    async def test_privacy(self) -> None:
        ...
        public_fact_for_private_citation_for_public_contained_source = Person(id='FACT7')
        PersonName(
        ...
        public_fact_for_public_citation_for_private_contained_source = Person(id='FACT7')
        PersonName(
        ...
        public_fact_for_private_citation_for_private_contained_source = Person(id='FACT7')
        PersonName(
        ...
        async with self._render(
            ...
            assert public_file_for_public_citation_for_public_contained_source.description is not None
            ...
            assert private_file_for_public_citation_for_public_contained_source.description is not None
            assert private_file_for_public_citation_for_public_contained_source.description not in actual
            assert public_file_for_private_citation_for_public_contained_source.description is not None
            assert public_file_for_private_citation_for_public_contained_source.description not in actual
            assert private_file_for_private_citation_for_public_contained_source.description is not None
            assert private_file_for_private_citation_for_public_contained_source.description not in actual
            assert public_file_for_public_citation_for_private_contained_source.description is not None
            assert public_file_for_public_citation_for_private_contained_source.description not in actual
            assert private_file_for_public_citation_for_private_contained_source.description is not None
            assert private_file_for_public_citation_for_private_contained_source.description not in actual
            assert public_file_for_private_citation_for_private_contained_source.description is not None
            assert public_file_for_private_citation_for_private_contained_source.description not in actual
            assert private_file_for_private_citation_for_private_contained_source.description is not None
