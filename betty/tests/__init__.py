...
@deprecated(f'The `@patch_cache` decorator is deprecated as of Betty 0.3.2, and will be removed in Bety 0.4.x. Use the `{binary_file_cache.__name__}` fixture instead.')
