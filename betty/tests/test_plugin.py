...
from betty.plugin.ordered import OrderedClassedPluginDefinition
...
class _OrderedPluginDefinition(OrderedClassedPluginDefinition[DummyPlugin]):
    pass


_ordered_plugin_comes_before_target: Final[OrderedClassedPluginDefinition] = (
    _OrderedPluginDefinition("ordered-plugin-comes-before-target")
)

_ordered_plugin_has_comes_before: Final[OrderedClassedPluginDefinition] = (
    _OrderedPluginDefinition(
        "ordered-plugin-has-comes-before",
        before={_ordered_plugin_comes_before_target},
    )
)
_ordered_plugin_comes_after_target: Final[OrderedClassedPluginDefinition] = (
    _OrderedPluginDefinition("ordered-plugin-comes-after-target")
)

_ordered_plugin_has_comes_after: Final[OrderedClassedPluginDefinition] = (
    _OrderedPluginDefinition(
        "ordered-plugin-has-comes-after", after={_ordered_plugin_comes_after_target}
    )
)

_ordered_plugin_isolated: Final[OrderedClassedPluginDefinition] = (
    _OrderedPluginDefinition("ordered-plugin-isolated")
)


_ordered_plugin_has_comes_before_bidirectional: Final[
...
_ordered_plugin_has_comes_after_bidirectional: Final[OrderedClassedPluginDefinition] = (
    _OrderedPluginDefinition(
