...
async def test_create_file(tmp_path: Path, path_segments: Sequence[str]) -> None:
...
async def test_create_html_resource(tmp_path: Path) -> None:
...
async def test_create_json_resource(tmp_path: Path) -> None:
    resource_path = tmp_path / "resource"
    content = "Hello, world!"
