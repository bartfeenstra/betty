...
async def test_privacy() -> None:
    ...
    async with assert_template_file(
        ...
        assert public_enclosed_event.description.localize(DEFAULT_LOCALIZER) in actual

        assert private_place_event.description
        assert private_place_event.description.localize(DEFAULT_LOCALIZER) not in actual
        assert private_enclosed_event.description
        assert (
            private_enclosed_event.description.localize(DEFAULT_LOCALIZER) not in actual
        )
