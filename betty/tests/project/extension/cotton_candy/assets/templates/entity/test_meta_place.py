...
async def test_without_enclosing_places() -> None:
    place = Place(
        id="P0",
...
async def test_with_enclosing_place_without_place_context() -> None:
    place = Place(
        id="P0",
        names=[Name("The Place")],
    )
...
async def test_with_enclosing_place_with_matching_place_context() -> None:
    place = Place(
        id="P0",
        names=[Name("The Place")],
    )
...
async def test_with_enclosing_place_with_non_matching_place_context() -> None:
    place = Place(
        id="P0",
        names=[Name("The Place")],
    )
