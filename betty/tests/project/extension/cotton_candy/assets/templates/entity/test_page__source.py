...
async def test_privacy(tmp_path: Path) -> None:
    ...
    FileReference(private_contained_source, public_file_for_private_contained_source)
    ...
    FileReference(private_contained_source, private_file_for_private_contained_source)
    ...
    async with assert_template_file(
        ...
        assert public_file_for_public_citation_for_public_contained_source.description
        assert (
        ...
        assert (
            public_fact_for_public_citation_for_public_contained_source_name in actual
        )
        ...
        assert (
            private_file_for_private_citation.description.localize(DEFAULT_LOCALIZER)
            not in actual
        )
        ...
        assert private_file_for_public_citation_for_public_contained_source.description
        assert (
        ...
        assert public_file_for_private_citation_for_public_contained_source.description
        assert (
        ...
        assert public_file_for_public_citation_for_private_contained_source.description
        assert (
