...
class _CottonCandy(Theme, CssProvider, ConfigurableExtension[CottonCandyConfiguration], GuiBuilder, Jinja2Provider, _WebpackEntrypointProvider):
    @classmethod
    ...
    def public_css_paths(self) -> list[str]:
        return [
            self.app.static_url_generator.generate('css/betty.extension.CottonCandy.css'),
        ]
