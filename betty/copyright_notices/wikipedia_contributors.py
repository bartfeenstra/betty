...
if TYPE_CHECKING:
    ...
    from betty.localizable import Localizable, StaticTranslationsMapping
...
async def _discover(
    app: App,
) -> AsyncIterable[ResolvableDiscovery[CopyrightNoticeDefinition]]:
    ...
    @CopyrightNoticeDefinition(
        "wikipedia-contributors", label=_("Wikipedia contributors")
    )
    class _WikipediaContributors(CopyrightNotice):
        _url: ClassVar[Localizable] = StaticTranslations(urls)
