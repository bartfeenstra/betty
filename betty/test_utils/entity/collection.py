...
class EntityCollectionTestBase[EntityT: Entity]:
    """
    A base class for testing :py:class:`betty.entity.collection.EntityCollection` implementations.
    """
    ...
    async def test_entity_collection_test_base_sut_entities(
        ...
        """
        Tests :py:meth:`betty.test_utils.entity.collection.EntityCollectionTestBase.sut_entities` implementations.
        """
    ...
    async def test_add(
        ...
        """
        Tests :py:meth:`betty.entity.collection.EntityCollection.add` implementations.
        """
    ...
    async def test_remove(
        ...
        """
        Tests :py:meth:`betty.entity.collection.EntityCollection.remove` implementations.
        """
        sut.add(*sut_entities)
    ...
    async def test___delitem____by_entity(
        ...
        """
        Tests :py:meth:`betty.entity.collection.EntityCollection.__delitem__` implementations.
        """
        sut.add(*sut_entities)
        first = sut_entities[0]
        sut.add(*sut_entities)
    ...
    async def test___contains____by_entity(
        ...
        """
        Tests :py:meth:`betty.entity.collection.EntityCollection.__contains__` implementations.
        """
    ...
    async def test___len__(
        ...
        """
        Tests :py:meth:`betty.entity.collection.EntityCollection.__len__` implementations.
        """
        assert len(sut) == 0
        sut.add(*sut_entities)
    ...
    async def test___iter__(
        ...
        """
        Tests :py:meth:`betty.entity.collection.EntityCollection.__iter__` implementations.
        """
    ...
    async def test_replace(
        ...
        """
        Tests :py:meth:`betty.entity.collection.EntityCollection.replace` implementations.
        """
        first = sut_entities[0]
