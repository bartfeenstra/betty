...
class EntryPointProviderTestBase(ExtensionTestBase[EntryPointProvider]):
    """
    A base class for testing :py:class:`betty.project.extension.webpack.build.EntryPointProvider` implementations.
    """

    def test_webpack_entry_point_directory_path(self) -> None:
        """
        Tests :py:meth:`betty.project.extension.webpack.build.EntryPointProvider.webpack_entry_point_directory_path` implementations.
        """
    ...
    async def test_webpack_entry_point_cache_keys(self, new_temporary_app: App) -> None:
        """
        Tests :py:meth:`betty.project.extension.webpack.build.EntryPointProvider.webpack_entry_point_cache_keys` implementations.
        """
