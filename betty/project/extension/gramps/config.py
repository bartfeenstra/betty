...
class FamilyTreeConfiguration(Configuration):
    ...
    def __init__(
        ...
        *,
        event_types: Mapping[
            str,
            PluginInstanceConfiguration[PluginDefinition[EventType], EventType],
        ]
        | None = None,
        place_types: Mapping[
            str,
            PluginInstanceConfiguration[PluginDefinition[PlaceType], PlaceType],
        ]
        | None = None,
        presence_roles: Mapping[
            str,
            PluginInstanceConfiguration[PluginDefinition[PresenceRole], PresenceRole],
        ]
        | None = None,
    ):
        super().__init__()
        self._source = source
        self._event_types = PluginMapping[PluginDefinition[EventType], EventType](
            {
        ...
        self._place_types = PluginMapping[PluginDefinition[PlaceType], PlaceType](
            {
                gramps_value: PluginInstanceConfiguration(event_type)
        ...
        self._presence_roles = PluginMapping[
            PluginDefinition[PresenceRole], PresenceRole
        ](
            {
                gramps_value: PluginInstanceConfiguration(event_type)
    ...
    def event_types(
        self,
    ) -> PluginMapping[PluginDefinition[EventType], EventType]:
        """
    ...
    def place_types(
        self,
    ) -> PluginMapping[PluginDefinition[PlaceType], PlaceType]:
        """
    ...
    def presence_roles(
        self,
    ) -> PluginMapping[PluginDefinition[PresenceRole], PresenceRole]:
        """
