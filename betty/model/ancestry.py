...
from typing import List, Optional, Set, Sequence, TYPE_CHECKING, Iterator, Iterable, Any
...
class File(Described, HasPrivacy, HasMediaType, HasNotes, HasCitations):
...
class Source(Dated, HasFiles, HasLinks, HasPrivacy):
    name: Optional[str]
    contained_by: Source
...
class Citation(Dated, HasFiles, HasPrivacy):
...
class Event(Dated, HasFiles, HasCitations, Described, HasPrivacy):
    place: Place
...
class Person(HasFiles, HasCitations, HasLinks, HasPrivacy):
