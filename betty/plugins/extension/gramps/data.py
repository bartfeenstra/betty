"""
Data for the :py:class:`betty.plugins.extension.gramps.Gramps` extension.
"""
...
class FamilyTree(Data):
    ...
    .. data:: betty.plugins.extension.gramps.data:FamilyTree
    """
...
class GrampsConfiguration(Data):
    """
    Configuration for the :py:class:`betty.plugins.extension.gramps.Gramps` extension.

    .. data:: betty.plugins.extension.gramps.data:GrampsConfiguration
    """
