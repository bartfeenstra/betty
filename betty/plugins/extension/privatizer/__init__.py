...
from betty.plugins.extension.deriver.jobs import DeriveAncestry
from betty.plugins.extension.privatizer.jobs import PrivatizeAncestry
...
class Privatizer(PostLoader, Manufacturable, Extension):
    ...
    People
      ...
      :py:const:`defaults to 123 years <betty.project.data.DEFAULT_LIFETIME_THRESHOLD>`, but can be changed in your
      project's :py:class:`configuration <betty.project.data.ProjectConfiguration>`.
