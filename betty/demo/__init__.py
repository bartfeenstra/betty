...
class Demo(Extension, Loader):
    ...
    async def load(self) -> None:
        ...
        self._app.project.ancestry.entities.append(personal_accounts)

        cite_first_person_account = Citation('betty-demo-first-person-account', personal_accounts)
        self._app.project.ancestry.entities.append(cite_first_person_account)
        ...
        self._app.project.ancestry.entities.append(bevolkingsregister_amsterdam)
        ...
        self._app.project.ancestry.entities.append(david_marinus_lankester)

        geertruida_van_ling = Person('betty-demo-geertruida-van-ling')
        PersonName(geertruida_van_ling, 'Geertruida', 'Van Ling')
        self._app.project.ancestry.entities.append(geertruida_van_ling)
        ...
        self._app.project.ancestry.entities.append(marriage_of_dirk_jacobus_lankester_and_jannigje_palsen)
        ...
        self._app.project.ancestry.entities.append(birth_of_dirk_jacobus_lankester)
        ...
        self._app.project.ancestry.entities.append(death_of_dirk_jacobus_lankester)
        ...
        self._app.project.ancestry.entities.append(dirk_jacobus_lankester)
        ...
        self._app.project.ancestry.entities.append(birth_of_marinus_david_lankester)
        ...
        self._app.project.ancestry.entities.append(death_of_marinus_david_lankester)
        ...
        self._app.project.ancestry.entities.append(marinus_david_lankester)
        ...
        self._app.project.ancestry.entities.append(birth_of_jacoba_gesina_lankester)
        ...
        self._app.project.ancestry.entities.append(jacoba_gesina_lankester)
        ...
        self._app.project.ancestry.entities.append(jannigje_palsen)
        ...
        self._app.project.ancestry.entities.append(marriage_of_johan_de_boer_and_liberta_lankester)
        ...
        self._app.project.ancestry.entities.append(cite_birth_of_liberta_lankester_from_bevolkingsregister_amsterdam)
        ...
        self._app.project.ancestry.entities.append(birth_of_liberta_lankester)
        ...
        self._app.project.ancestry.entities.append(death_of_liberta_lankester)
        ...
        self._app.project.ancestry.entities.append(liberta_lankester)
        ...
        self._app.project.ancestry.entities.append(birth_of_johan_de_boer)
        ...
        self._app.project.ancestry.entities.append(death_of_johan_de_boer)
        ...
        self._app.project.ancestry.entities.append(johan_de_boer)
        ...
        self._app.project.ancestry.entities.append(parent_of_bart_feenstra_child_of_liberta_lankester)
