...
from betty.service.requirement import UnmetRequirement, require_project
...
class ProjectDiscovery(PluginDiscovery[_PluginDefinitionT]):
    ...
    @require_project
    async def _discover(self, *, project: Project) -> Iterable[_PluginDefinitionT]:
        return await resolve_await(self._discovery(project))
