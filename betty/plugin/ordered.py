...
def sort_ordered_plugin_graph(
    available_plugins: KeyedCollection[Any, ResolvableId, _OrderedPluginDefinitionT],
...
def get_comes_before(
    ...
    for plugin in available_plugins:
        for comes_before_id in plugin.comes_before:
            comes_before = available_plugins[comes_before_id]
            graph[plugin].add(comes_before)
        for comes_after_id in plugin.comes_after:
            comes_after = available_plugins[comes_after_id]
