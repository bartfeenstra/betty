...
@deprecated(f"This class is deprecated as of Betty 0.3.2, and will be removed in Betty 0.4.x. It exists only for App.cache's backwards compatibility. Use {Cache} instead.")
class FileCache:
    @property
